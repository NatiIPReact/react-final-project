...
// This is the song's report (for admins)
const SongsReport = () => {
        ...
        <LinearGradient colors={['#040306', '#131624']} style={{ flex: 1 }}>
            <SafeAreaView style={styles.safeArea}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.loginText}>Songs Report</Text>
                </View>
                <ScrollView  style={{
                    flex: 1,
                    padding: 10,
                    ...
                    {songsData?.map((item, index) => (
                        <View key={index} style={styles.dataRow}>
                            <Text style={styles.dataCell}>{item?.songID}</Text>
                            <Text style={styles.dataCell}>{item?.songName}</Text>
                            <Text style={styles.dataCell}>{item?.releaseYear}</Text>
                            ...
                            <Text style={styles.dataCell}>{item?.totalFavorites}</Text>
                        </View>
                    ))}
                </ScrollView>
            </SafeAreaView>
